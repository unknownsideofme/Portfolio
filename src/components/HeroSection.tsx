...
const HeroSection = () => {
  const socialLinks = [
    ...
    { icon: Linkedin, href: "https://www.linkedin.com/in/debanjan-rakshit-558912289/", label: "LinkedIn" },
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    <div className="space-y-8 animate-fade-in text-center lg:text-left">
      ...
      <p className="text-base sm:text-lg text-gray-400 leading-relaxed max-w-md mx-auto lg:mx-0">
        Pre Final Year at NIT-B. <br />
        Passionate about leveraging data structures, algorithms, and machine learning to develop innovative solutions.
      </p>
